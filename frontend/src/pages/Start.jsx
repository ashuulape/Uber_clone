...
const start = () => {
  return (
    <div className='bg-[url(https://i.pinimg.com/736x/22/e9/a3/22e9a38fdab27d1bafac714dd9eee06c.jpg)] bg-center bg-cover h-screen w-screen flex flex-col  justify-between '>
